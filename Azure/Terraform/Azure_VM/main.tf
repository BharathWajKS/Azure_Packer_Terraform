...
terraform {
    ...
    backend "azurerm" {
      ...
      storage_account_name = "rackspace37d7ce32"
...
output "image_id" {
  value = "/subscriptions/93ab47bf-076c-43e0-9d6c-7c34fe77152a/resourceGroups/myResourceGroup/providers/Microsoft.Compute/images/myPackerImage"
}
